...
class $CombosTableTable extends CombosTable
    with TableInfo<$CombosTableTable, ComboEntity> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CombosTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'combos_table';
  @override
  VerificationContext validateIntegrity(
    Insertable<ComboEntity> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ComboEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ComboEntity(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
  ...
  @override
  $CombosTableTable createAlias(String alias) {
    return $CombosTableTable(attachedDatabase, alias);
  }
}

class ComboEntity extends DataClass implements Insertable<ComboEntity> {
  final int id;
  final DateTime createdAt;
  final DateTime? updatedAt;
  final DateTime? deletedAt;
  ...
  CombosTableCompanion toCompanion(bool nullToAbsent) {
  ...
  ComboEntity copyWithCompanion(CombosTableCompanion data) {
    return ComboEntity(
      id: data.id.present ? data.id.value : this.id,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('ComboEntity(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, createdAt, updatedAt, deletedAt, name, price, isEnabled);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ComboEntity &&
          other.id == this.id &&
          other.createdAt == this.createdAt &&
          other.updatedAt == this.updatedAt &&
          other.deletedAt == this.deletedAt &&
...
class CombosTableCompanion extends UpdateCompanion<ComboEntity> {
  final Value<int> id;
  final Value<DateTime> createdAt;
  final Value<DateTime?> updatedAt;
  final Value<DateTime?> deletedAt;
  ...
  CombosTableCompanion.insert({
    ...
    this.isEnabled = const Value.absent(),
       ...
       price = Value(price);
  static Insertable<ComboEntity> custom({
    Expression<int>? id,
    Expression<DateTime>? createdAt,
    Expression<DateTime>? updatedAt,
    Expression<DateTime>? deletedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('CombosTableCompanion(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
...
class $OrderItemsTableTable extends OrderItemsTable
  ...
  static const VerificationMeta _comboLineIdMeta = const VerificationMeta(
    'comboLineId',
  );
  @override
  late final GeneratedColumn<int> comboLineId = GeneratedColumn<int>(
    'combo_line_id',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _comboSaleQuantityMeta = const VerificationMeta(
    'comboSaleQuantity',
  );
  @override
  late final GeneratedColumn<int> comboSaleQuantity = GeneratedColumn<int>(
    'combo_sale_quantity',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('combo_line_id')) {
      context.handle(
        _comboLineIdMeta,
        comboLineId.isAcceptableOrUnknown(
          data['combo_line_id']!,
          _comboLineIdMeta,
        ),
      );
    }
    if (data.containsKey('combo_sale_quantity')) {
      context.handle(
        _comboSaleQuantityMeta,
        comboSaleQuantity.isAcceptableOrUnknown(
          data['combo_sale_quantity']!,
          _comboSaleQuantityMeta,
        ),
      );
    }
  ...
  OrderItemEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return OrderItemEntity(
      ...
      comboLineId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}combo_line_id'],
      ),
      comboSaleQuantity: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}combo_sale_quantity'],
      ),
    );
  }
...
class OrderItemEntity extends DataClass implements Insertable<OrderItemEntity> {
  ...
  final int? comboLineId;
  final int? comboSaleQuantity;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || comboLineId != null) {
      map['combo_line_id'] = Variable<int>(comboLineId);
    }
    if (!nullToAbsent || comboSaleQuantity != null) {
      map['combo_sale_quantity'] = Variable<int>(comboSaleQuantity);
    }
    return map;
  }
  ...
  OrderItemsTableCompanion toCompanion(bool nullToAbsent) {
    return OrderItemsTableCompanion(
      ...
      comboName: comboName == null && nullToAbsent
          ? const Value.absent()
          : Value(comboName),
      comboLineId: comboLineId == null && nullToAbsent
          ? const Value.absent()
          : Value(comboLineId),
      comboSaleQuantity: comboSaleQuantity == null && nullToAbsent
          ? const Value.absent()
  ...
  factory OrderItemEntity.fromJson(
    ...
    return OrderItemEntity(
      ...
      comboLineId: serializer.fromJson<int?>(json['comboLineId']),
      comboSaleQuantity: serializer.fromJson<int?>(json['comboSaleQuantity']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'comboLineId': serializer.toJson<int?>(comboLineId),
      'comboSaleQuantity': serializer.toJson<int?>(comboSaleQuantity),
    };
  }
  ...
  OrderItemEntity copyWith({
    ...
    Value<int?> comboLineId = const Value.absent(),
    Value<int?> comboSaleQuantity = const Value.absent(),
  }) => OrderItemEntity(
    id: id ?? this.id,
    createdAt: createdAt ?? this.createdAt,
    updatedAt: updatedAt.present ? updatedAt.value : this.updatedAt,
    ...
    comboLineId: comboLineId.present ? comboLineId.value : this.comboLineId,
    comboSaleQuantity: comboSaleQuantity.present
        ? comboSaleQuantity.value
        : this.comboSaleQuantity,
  );
  OrderItemEntity copyWithCompanion(OrderItemsTableCompanion data) {
    return OrderItemEntity(
      ...
      comboLineId: data.comboLineId.present
          ? data.comboLineId.value
          : this.comboLineId,
      comboSaleQuantity: data.comboSaleQuantity.present
          ? data.comboSaleQuantity.value
          : this.comboSaleQuantity,
    );
  }
  ...
  String toString() {
    return (StringBuffer('OrderItemEntity(')
          ...
          ..write('comboLineId: $comboLineId, ')
          ..write('comboSaleQuantity: $comboSaleQuantity')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is OrderItemEntity &&
          ...
          other.comboLineId == this.comboLineId &&
          other.comboSaleQuantity == this.comboSaleQuantity);
}
...
class OrderItemsTableCompanion extends UpdateCompanion<OrderItemEntity> {
  ...
  final Value<int?> comboLineId;
  final Value<int?> comboSaleQuantity;
  const OrderItemsTableCompanion({
    ...
    this.comboLineId = const Value.absent(),
    this.comboSaleQuantity = const Value.absent(),
  });
  ...
  static Insertable<OrderItemEntity> custom({
    ...
    Expression<int>? comboLineId,
    Expression<int>? comboSaleQuantity,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (createdAt != null) 'created_at': createdAt,
      ...
      if (comboLineId != null) 'combo_line_id': comboLineId,
      if (comboSaleQuantity != null) 'combo_sale_quantity': comboSaleQuantity,
    });
  }
  ...
  OrderItemsTableCompanion copyWith({
    ...
    Value<int?>? comboLineId,
    Value<int?>? comboSaleQuantity,
  }) {
    return OrderItemsTableCompanion(
      id: id ?? this.id,
      createdAt: createdAt ?? this.createdAt,
      ...
      comboLineId: comboLineId ?? this.comboLineId,
      comboSaleQuantity: comboSaleQuantity ?? this.comboSaleQuantity,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (comboLineId.present) {
      map['combo_line_id'] = Variable<int>(comboLineId.value);
    }
    if (comboSaleQuantity.present) {
      map['combo_sale_quantity'] = Variable<int>(comboSaleQuantity.value);
    }
    return map;
  }
...
class $ClockRecordsTableTable extends ClockRecordsTable
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ClockRecordsTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'clock_records_table';
  @override
  VerificationContext validateIntegrity(
    Insertable<ClockRecordEntity> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ClockRecordEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ClockRecordEntity(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $ClockRecordsTableTable createAlias(String alias) {
    return $ClockRecordsTableTable(attachedDatabase, alias);
  }
}

class ClockRecordEntity extends DataClass
    implements Insertable<ClockRecordEntity> {
  final int id;
  final DateTime createdAt;
  final DateTime? updatedAt;
  final DateTime? deletedAt;
  ...
  ClockRecordsTableCompanion toCompanion(bool nullToAbsent) {
    return ClockRecordsTableCompanion(
      id: Value(id),
      createdAt: Value(createdAt),
      updatedAt: updatedAt == null && nullToAbsent
          ? const Value.absent()
  ...
  factory ClockRecordEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ClockRecordEntity copyWithCompanion(ClockRecordsTableCompanion data) {
    return ClockRecordEntity(
      id: data.id.present ? data.id.value : this.id,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('ClockRecordEntity(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
...
class ClockRecordsTableCompanion extends UpdateCompanion<ClockRecordEntity> {
  final Value<int> id;
  final Value<DateTime> createdAt;
  final Value<DateTime?> updatedAt;
  final Value<DateTime?> deletedAt;
  ...
  final Value<String?> note;
  const ClockRecordsTableCompanion({
    this.id = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.deletedAt = const Value.absent(),
  ...
  ClockRecordsTableCompanion.insert({
    ...
    this.note = const Value.absent(),
       ...
       clockedInAt = Value(clockedInAt);
  static Insertable<ClockRecordEntity> custom({
    Expression<int>? id,
    Expression<DateTime>? createdAt,
    Expression<DateTime>? updatedAt,
    Expression<DateTime>? deletedAt,
  ...
  ClockRecordsTableCompanion copyWith({
    Value<int>? id,
    Value<DateTime>? createdAt,
    Value<DateTime?>? updatedAt,
    Value<DateTime?>? deletedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('ClockRecordsTableCompanion(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
...
class $ComboItemsTableTable extends ComboItemsTable
    with TableInfo<$ComboItemsTableTable, ComboItemEntity> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ComboItemsTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  late final GeneratedColumn<int> comboId = GeneratedColumn<int>(
    ...
    requiredDuringInsert: true,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'REFERENCES combos_table (id) ON DELETE CASCADE',
    ),
  );
  static const VerificationMeta _productIdMeta = const VerificationMeta(
    'productId',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'combo_items_table';
  @override
  VerificationContext validateIntegrity(
    Insertable<ComboItemEntity> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ComboItemEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $ComboItemsTableTable createAlias(String alias) {
    return $ComboItemsTableTable(attachedDatabase, alias);
  }
}

class ComboItemEntity extends DataClass implements Insertable<ComboItemEntity> {
  final int id;
  final DateTime createdAt;
  final DateTime? updatedAt;
  final DateTime? deletedAt;
  ...
  ComboItemsTableCompanion toCompanion(bool nullToAbsent) {
    return ComboItemsTableCompanion(
      id: Value(id),
      createdAt: Value(createdAt),
      updatedAt: updatedAt == null && nullToAbsent
          ? const Value.absent()
  ...
  factory ComboItemEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ComboItemEntity copyWithCompanion(ComboItemsTableCompanion data) {
    return ComboItemEntity(
      id: data.id.present ? data.id.value : this.id,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('ComboItemEntity(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
...
class ComboItemsTableCompanion extends UpdateCompanion<ComboItemEntity> {
  final Value<int> id;
  final Value<DateTime> createdAt;
  final Value<DateTime?> updatedAt;
  final Value<DateTime?> deletedAt;
  ...
  final Value<String> productName;
  final Value<int> quantity;
  const ComboItemsTableCompanion({
    this.id = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.deletedAt = const Value.absent(),
  ...
  ComboItemsTableCompanion.insert({
    ...
    this.quantity = const Value.absent(),
       ...
       productId = Value(productId),
       productName = Value(productName);
  static Insertable<ComboItemEntity> custom({
    Expression<int>? id,
    Expression<DateTime>? createdAt,
    Expression<DateTime>? updatedAt,
    Expression<DateTime>? deletedAt,
  ...
  ComboItemsTableCompanion copyWith({
    Value<int>? id,
    Value<DateTime>? createdAt,
    Value<DateTime?>? updatedAt,
    Value<DateTime?>? deletedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('ComboItemsTableCompanion(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
...
abstract class _$RingoDatabase extends GeneratedDatabase {
  _$RingoDatabase(QueryExecutor e) : super(e);
  $RingoDatabaseManager get managers => $RingoDatabaseManager(this);
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('combo_items_table', kind: UpdateKind.delete)],
    ),
  ]);
}
...
final class $$CategoriesTableTableReferences
    extends
        BaseReferences<_$RingoDatabase, $CategoriesTableTable, CategoryEntity> {
  ...
  _productsTableRefsTable(_$RingoDatabase db) => MultiTypedResultKey.fromTable(
    db.productsTable,
...
class $$CategoriesTableTableFilterComposer
    extends Composer<_$RingoDatabase, $CategoriesTableTable> {
...
final class $$ProductsTableTableReferences
    extends
        BaseReferences<_$RingoDatabase, $ProductsTableTable, ProductEntity> {
  ...
  static $CategoriesTableTable _categoryIdTable(_$RingoDatabase db) =>
  ...
  >
  _productModifierLinksTableRefsTable(_$RingoDatabase db) =>
  ...
  _stocksTableRefsTable(_$RingoDatabase db) => MultiTypedResultKey.fromTable(
    db.stocksTable,
    aliasName: $_aliasNameGenerator(
      db.productsTable.id,
  ...
  >
  _stockMovementsTableRefsTable(_$RingoDatabase db) =>
      MultiTypedResultKey.fromTable(
  ...
  _orderItemsTableRefsTable(_$RingoDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.orderItemsTable,
        aliasName: $_aliasNameGenerator(
          db.productsTable.id,
  ...
  static MultiTypedResultKey<$ComboItemsTableTable, List<ComboItemEntity>>
  _comboItemsTableRefsTable(_$RingoDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.comboItemsTable,
        aliasName: $_aliasNameGenerator(
          db.productsTable.id,
          db.comboItemsTable.productId,
        ),
      );

  $$ComboItemsTableTableProcessedTableManager get comboItemsTableRefs {
    final manager = $$ComboItemsTableTableTableManager(
      $_db,
      $_db.comboItemsTable,
    ).filter((f) => f.productId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _comboItemsTableRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$ProductsTableTableFilterComposer
    extends Composer<_$RingoDatabase, $ProductsTableTable> {
  $$ProductsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  Expression<bool> comboItemsTableRefs(
    Expression<bool> Function($$ComboItemsTableTableFilterComposer f) f,
  ) {
    final $$ComboItemsTableTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.comboItemsTable,
      getReferencedColumn: (t) => t.productId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ComboItemsTableTableFilterComposer(
            $db: $db,
            $table: $db.comboItemsTable,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$ProductsTableTableAnnotationComposer
  ...
  Expression<T> comboItemsTableRefs<T extends Object>(
    Expression<T> Function($$ComboItemsTableTableAnnotationComposer a) f,
  ) {
    final $$ComboItemsTableTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.comboItemsTable,
      getReferencedColumn: (t) => t.productId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ComboItemsTableTableAnnotationComposer(
            $db: $db,
            $table: $db.comboItemsTable,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
              ...
              ({
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (comboItemsTableRefs) db.comboItemsTable,
                  ],
                  addJoins:
                      <
...
final class $$ModifiersTableTableReferences
    extends
        BaseReferences<_$RingoDatabase, $ModifiersTableTable, ModifierEntity> {
  ...
  >
  _modifierOptionsTableRefsTable(_$RingoDatabase db) =>
      MultiTypedResultKey.fromTable(
...
class $$ModifiersTableTableFilterComposer
    extends Composer<_$RingoDatabase, $ModifiersTableTable> {
...
final class $$ModifierOptionsTableTableReferences
  ...
  static $ModifiersTableTable _modifierIdTable(_$RingoDatabase db) =>
...
class $$ModifierOptionsTableTableFilterComposer
    extends Composer<_$RingoDatabase, $ModifierOptionsTableTable> {
  $$ModifierOptionsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$ProductModifierLinksTableTableReferences
  ...
  static $ProductsTableTable _productIdTable(_$RingoDatabase db) =>
...
class $$ProductModifierLinksTableTableFilterComposer
    extends Composer<_$RingoDatabase, $ProductModifierLinksTableTable> {
  $$ProductModifierLinksTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$StocksTableTableReferences
    extends BaseReferences<_$RingoDatabase, $StocksTableTable, StockEntity> {
...
class $$StocksTableTableFilterComposer
    extends Composer<_$RingoDatabase, $StocksTableTable> {
  $$StocksTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$StocksTableTableTableManager
    extends
        ...
        > {
  $$StocksTableTableTableManager(_$RingoDatabase db, $StocksTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$StockMovementsTableTableFilterComposer
    extends Composer<_$RingoDatabase, $StockMovementsTableTable> {
  $$StockMovementsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$EmployeesTableTableReferences
    extends
        BaseReferences<_$RingoDatabase, $EmployeesTableTable, EmployeeEntity> {
  ...
  _ordersTableRefsTable(_$RingoDatabase db) => MultiTypedResultKey.fromTable(
    db.ordersTable,
    aliasName: $_aliasNameGenerator(
  ...
  _clockRecordsTableRefsTable(_$RingoDatabase db) =>
      MultiTypedResultKey.fromTable(
...
class $$EmployeesTableTableFilterComposer
    extends Composer<_$RingoDatabase, $EmployeesTableTable> {
...
final class $$OrdersTableTableReferences
    extends BaseReferences<_$RingoDatabase, $OrdersTableTable, OrderEntity> {
  $$OrdersTableTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $EmployeesTableTable _employeeIdTable(_$RingoDatabase db) =>
...
class $$OrdersTableTableFilterComposer
    extends Composer<_$RingoDatabase, $OrdersTableTable> {
  $$OrdersTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$OrdersTableTableTableManager
    extends
        ...
        > {
  $$OrdersTableTableTableManager(_$RingoDatabase db, $OrdersTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$CombosTableTableUpdateCompanionBuilder =
    CombosTableCompanion Function({
      Value<int> id,
      Value<DateTime> createdAt,
      Value<DateTime?> updatedAt,
...
final class $$CombosTableTableReferences
    extends BaseReferences<_$RingoDatabase, $CombosTableTable, ComboEntity> {
  $$CombosTableTableReferences(super.$_db, super.$_table, super.$_typedResult);
...
class $$CombosTableTableFilterComposer
    extends Composer<_$RingoDatabase, $CombosTableTable> {
  $$CombosTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CombosTableTableOrderingComposer
    extends Composer<_$RingoDatabase, $CombosTableTable> {
  $$CombosTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CombosTableTableAnnotationComposer
    extends Composer<_$RingoDatabase, $CombosTableTable> {
  $$CombosTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CombosTableTableTableManager
    extends
        RootTableManager<
          _$RingoDatabase,
          $CombosTableTable,
          ...
          $$CombosTableTableOrderingComposer,
          $$CombosTableTableAnnotationComposer,
          $$CombosTableTableCreateCompanionBuilder,
          $$CombosTableTableUpdateCompanionBuilder,
          (ComboEntity, $$CombosTableTableReferences),
          ComboEntity,
          PrefetchHooks Function({
            bool orderItemsTableRefs,
            bool comboItemsTableRefs,
        ...
        > {
  $$CombosTableTableTableManager(_$RingoDatabase db, $CombosTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CombosTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CombosTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CombosTableTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$CombosTableTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback:
              ({orderItemsTableRefs = false, comboItemsTableRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (orderItemsTableRefs) db.orderItemsTable,
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      if (orderItemsTableRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$CombosTableTableReferences
                              ._orderItemsTableRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$CombosTableTableReferences(
                                db,
                                table,
                                p0,
                              ).orderItemsTableRefs,
...
typedef $$CombosTableTableProcessedTableManager =
    ProcessedTableManager<
      _$RingoDatabase,
      $CombosTableTable,
      ComboEntity,
...
final class $$OrderItemsTableTableReferences
  ...
  static $OrdersTableTable _orderIdTable(_$RingoDatabase db) =>
  ...
  static $CombosTableTable _comboIdTable(_$RingoDatabase db) =>
      db.combosTable.createAlias(
        $_aliasNameGenerator(db.orderItemsTable.comboId, db.combosTable.id),
      );

  $$CombosTableTableProcessedTableManager? get comboId {
    final $_column = $_itemColumn<int>('combo_id');
    if ($_column == null) return null;
    final manager = $$CombosTableTableTableManager(
      $_db,
      $_db.combosTable,
    ).filter((f) => f.id.sqlEquals($_column));
  ...
  >
  _orderItemModifiersRefsTable(_$RingoDatabase db) =>
      MultiTypedResultKey.fromTable(
...
class $$OrderItemsTableTableFilterComposer
    extends Composer<_$RingoDatabase, $OrderItemsTableTable> {
  $$OrderItemsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  ColumnFilters<int> get comboLineId => $composableBuilder(
    column: $table.comboLineId,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<int> get comboSaleQuantity => $composableBuilder(
    column: $table.comboSaleQuantity,
    builder: (column) => ColumnFilters(column),
  );
  ...
  $$CombosTableTableFilterComposer get comboId {
    final $$CombosTableTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.comboId,
      referencedTable: $db.combosTable,
      getReferencedColumn: (t) => t.id,
      builder:
          (
            joinBuilder, {
...
class $$OrderItemsTableTableOrderingComposer
  ...
  ColumnOrderings<int> get comboLineId => $composableBuilder(
    column: $table.comboLineId,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get comboSaleQuantity => $composableBuilder(
    column: $table.comboSaleQuantity,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  $$CombosTableTableOrderingComposer get comboId {
    final $$CombosTableTableOrderingComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.comboId,
      referencedTable: $db.combosTable,
      getReferencedColumn: (t) => t.id,
...
class $$OrderItemsTableTableAnnotationComposer
  ...
  GeneratedColumn<int> get comboLineId => $composableBuilder(
    column: $table.comboLineId,
    builder: (column) => column,
  );

  GeneratedColumn<int> get comboSaleQuantity => $composableBuilder(
    column: $table.comboSaleQuantity,
    builder: (column) => column,
  );
  ...
  $$CombosTableTableAnnotationComposer get comboId {
    final $$CombosTableTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.comboId,
      referencedTable: $db.combosTable,
      getReferencedColumn: (t) => t.id,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                comboId: comboId,
                comboName: comboName,
                comboLineId: comboLineId,
                comboSaleQuantity: comboSaleQuantity,
              ),
          createCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
...
final class $$OrderItemModifiersTableReferences
  ...
  static $OrderItemsTableTable _orderItemIdTable(_$RingoDatabase db) =>
...
class $$OrderItemModifiersTableFilterComposer
    extends Composer<_$RingoDatabase, $OrderItemModifiersTable> {
  $$OrderItemModifiersTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$DiscountsTableTableFilterComposer
    extends Composer<_$RingoDatabase, $DiscountsTableTable> {
...
class $$AppSettingsTableTableFilterComposer
    extends Composer<_$RingoDatabase, $AppSettingsTableTable> {
...
class $$OutboxTableTableFilterComposer
    extends Composer<_$RingoDatabase, $OutboxTableTable> {
...
class $$OutboxTableTableTableManager
    extends
        RootTableManager<
          ...
          (
            OutboxEntity,
            BaseReferences<_$RingoDatabase, $OutboxTableTable, OutboxEntity>,
          ),
          OutboxEntity,
          PrefetchHooks Function()
        > {
  $$OutboxTableTableTableManager(_$RingoDatabase db, $OutboxTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$ClockRecordsTableTableUpdateCompanionBuilder =
    ClockRecordsTableCompanion Function({
      Value<int> id,
      Value<DateTime> createdAt,
      Value<DateTime?> updatedAt,
...
final class $$ClockRecordsTableTableReferences
    extends
        BaseReferences<
          _$RingoDatabase,
  ...
  >
  _cashReconciliationsTableRefsTable(_$RingoDatabase db) =>
      MultiTypedResultKey.fromTable(
...
class $$ClockRecordsTableTableFilterComposer
    extends Composer<_$RingoDatabase, $ClockRecordsTableTable> {
  $$ClockRecordsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ClockRecordsTableTableOrderingComposer
    extends Composer<_$RingoDatabase, $ClockRecordsTableTable> {
...
class $$ClockRecordsTableTableAnnotationComposer
    extends Composer<_$RingoDatabase, $ClockRecordsTableTable> {
  $$ClockRecordsTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$ClockRecordsTableTableTableManager
    extends
        RootTableManager<
          ...
          $$ClockRecordsTableTableOrderingComposer,
          $$ClockRecordsTableTableAnnotationComposer,
          $$ClockRecordsTableTableCreateCompanionBuilder,
  ...
  $$ClockRecordsTableTableTableManager(
    _$RingoDatabase db,
    $ClockRecordsTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ClockRecordsTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ClockRecordsTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ClockRecordsTableTableAnnotationComposer(
                $db: db,
                $table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$ClockRecordsTableTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback:
...
typedef $$ClockRecordsTableTableProcessedTableManager =
    ProcessedTableManager<
      _$RingoDatabase,
      $ClockRecordsTableTable,
      ClockRecordEntity,
...
typedef $$ComboItemsTableTableUpdateCompanionBuilder =
    ComboItemsTableCompanion Function({
      Value<int> id,
      Value<DateTime> createdAt,
      Value<DateTime?> updatedAt,
...
final class $$ComboItemsTableTableReferences
    extends
        BaseReferences<
          _$RingoDatabase,
          $ComboItemsTableTable,
          ComboItemEntity
        > {
  $$ComboItemsTableTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $CombosTableTable _comboIdTable(_$RingoDatabase db) =>
      db.combosTable.createAlias(
        $_aliasNameGenerator(db.comboItemsTable.comboId, db.combosTable.id),
      );
  ...
  static $ProductsTableTable _productIdTable(_$RingoDatabase db) =>
      db.productsTable.createAlias(
        $_aliasNameGenerator(db.comboItemsTable.productId, db.productsTable.id),
      );
...
class $$ComboItemsTableTableFilterComposer
    extends Composer<_$RingoDatabase, $ComboItemsTableTable> {
  $$ComboItemsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ComboItemsTableTableOrderingComposer
    extends Composer<_$RingoDatabase, $ComboItemsTableTable> {
  $$ComboItemsTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ComboItemsTableTableAnnotationComposer
    extends Composer<_$RingoDatabase, $ComboItemsTableTable> {
  $$ComboItemsTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$ComboItemsTableTableTableManager
    extends
        RootTableManager<
          _$RingoDatabase,
          $ComboItemsTableTable,
          ...
          $$ComboItemsTableTableOrderingComposer,
          $$ComboItemsTableTableAnnotationComposer,
          $$ComboItemsTableTableCreateCompanionBuilder,
          $$ComboItemsTableTableUpdateCompanionBuilder,
          (ComboItemEntity, $$ComboItemsTableTableReferences),
          ComboItemEntity,
          PrefetchHooks Function({bool comboId, bool productId})
        > {
  $$ComboItemsTableTableTableManager(
    _$RingoDatabase db,
    $ComboItemsTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ComboItemsTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ComboItemsTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ComboItemsTableTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$ComboItemsTableTableReferences(db, table, e),
                ),
              )
              .toList(),
...
typedef $$ComboItemsTableTableProcessedTableManager =
    ProcessedTableManager<
      _$RingoDatabase,
      $ComboItemsTableTable,
      ComboItemEntity,
...
final class $$CashReconciliationsTableTableReferences
  ...
  static $ClockRecordsTableTable _clockRecordIdTable(_$RingoDatabase db) =>
...
class $$CashReconciliationsTableTableFilterComposer
    extends Composer<_$RingoDatabase, $CashReconciliationsTableTable> {
  $$CashReconciliationsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$CatalogTemplatesTableTableFilterComposer
    extends Composer<_$RingoDatabase, $CatalogTemplatesTableTable> {
...
class $RingoDatabaseManager {
  final _$RingoDatabase _db;
  $RingoDatabaseManager(this._db);
  ...
  $$CombosTableTableTableManager get combosTable =>
      $$CombosTableTableTableManager(_db, _db.combosTable);
