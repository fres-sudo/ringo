...
void main() {
  testWidgets('explains that a ring sync is needed before data is shown', (
    ...
    expect(find.textContaining('Connect your ring and sync'), findsOneWidget);
  });
  ...
  testWidgets('shows the latest device-reported stage breakdown', (
    ...
    expect(find.textContaining('Light 5h 0m'), findsOneWidget);
    expect(find.textContaining('Deep 3h 0m'), findsOneWidget);
  });
}
